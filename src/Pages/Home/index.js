...
const Dashboard = Loadable(
  React.lazy(() => import("../../Component/Dashboard"))
);
const History = Loadable(React.lazy(() => import("../../Component/History")));
const Users = Loadable(React.lazy(() => import("../../Component/Users")));
const ControlPanel = Loadable(
  React.lazy(() => import("../../Component/ControlPanel"))
);
...
export default function Home() {
  ...
  React.useEffect(() => {
    if (content === "dashboard") {
      setContentComponent(<Dashboard />);
    } else if (content === "history") {
      setContentComponent(<History />);
    } else if (content === "users") {
      setContentComponent(<Users />);
    } else if (content === "control") {
      setContentComponent(<ControlPanel />);
    } else if (content === "plant") {
      setContentComponent(<Plant />);
    }
  }, [content]);
